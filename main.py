...
image = ImageCaptcha(fonts=['C:/Users/MCPab/Desktop/Captcha Generator/fonts/ChelseaMarketsr.ttf', 'C:/Users/MCPab/Desktop/Captcha Generator/fonts/DejaVuSanssr.ttf'])
...
root=Tk()
root.title("Captcha Generator made by Kazsuner")
photo = PhotoImage(file="out.png")
...
# Submit btn - Settings
b1=Button(root,text="Submit", width=10,font="Arial", command=verify)

# Refresh btn - Settings

b2=Button(root,text="Refresh", width=10, font="Arial",command=refresh)
